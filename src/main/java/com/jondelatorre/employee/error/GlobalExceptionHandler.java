...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleResourceNotFoundException(NotFoundException ex, WebRequest request) {
    ...
    protected ResponseEntity<Object> handleDuplicatedDbValue(DuplicateKeyException ex, WebRequest request) {
        HttpStatus status = HttpStatus.CONFLICT;
        ErrorDto errorDto = createErrorDto(status, "The chosen id already exists in the database. Please chose another one.", request);
        return handleExceptionInternal(ex, errorDto, new HttpHeaders(), status, request);
    }
